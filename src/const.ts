...
export interface GravandoState extends BaseFlashState {
...
export interface ErroState extends BaseFlashState {
  state: FlashStateType.ERROR;
  details: { error: FlashErro; details: string | Erro };
}
