...
export class EwtConsole extends HTMLElement {
  ...
  private _cancelConectarion?: () => Promise<void>;
  ...
  public async disconnect() {
    if (this._cancelConectarion) {
      await this._cancelConectarion();
      this._cancelConectarion = undefined;
    }
  }
